package my.dahr.heartrateometer
...
import my.dahr.heartrateometer.helper.MathHelper
import my.dahr.heartrateometer.camera.CameraSupport
import my.dahr.heartrateometer.camera.CameraSupportImpl
...
open class HeartRateOmeter {
    ...
    protected fun start() {
        ...
        context?.get()?.let {
            cameraSupport = CameraSupportImpl(context = it).open(0)
